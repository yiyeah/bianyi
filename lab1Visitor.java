...
public interface lab1Visitor<T> extends ParseTreeVisitor<T> {
	/**
	 * Visit a parse tree produced by {@link lab1Parser#treeRoot}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTreeRoot(lab1Parser.TreeRootContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link lab1Parser#funcRParams}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFuncRParams(lab1Parser.FuncRParamsContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab1Parser#funcFParams}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFuncFParams(lab1Parser.FuncFParamsContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab1Parser#funcFParam}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFuncFParam(lab1Parser.FuncFParamContext ctx);
	/**
